...
return [
    ...
    'setup' => [
        ...
        'mail_driver'      => 'E-posta Sürücü',
        'mail_host'        => 'E-posta Hostu',
        'mail_address'     => 'Gönderici e-postası',
    ...
    'settings' => [
        ...
        'analytics' => [
            'analytics_google'       => 'Google Analiz Kodu',
            'analytics_gosquared'    => 'GoSquared Analiz Kodu',
            'analytics_piwik_url'    => 'Piwik site adresi (http(s):// bağlantısı olmadan)',
            'analytics_piwik_siteid' => 'Piwik site kimliği',
        ],
        'localization' => [
        ...
        'security' => [
            ...
            'allowed-domains-help' => 'İzin verilen alan adlarını yukarıdan girebilirsiniz.',
        ],
        'stylesheet' => [
